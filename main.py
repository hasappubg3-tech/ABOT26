...
- new_row = true لكل زر يبدأ سطراً جديداً.
- new_row = false لوضع الزر بجانب الزر السابق في نفس السطر.
- الأزرار القصيرة يمكن وضع 2-3 منها في سطر واحد (new_row: false).
